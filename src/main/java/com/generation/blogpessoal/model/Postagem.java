...
public class Postagem {
	...
	"o atributo titulo deve ter no mínimo 5 e no máximo 100 caracteres") // validação e tratamento de erro
	...
	"o atributo texto deve ter no mínimo 10 e no máximo 1000 caracteres") // validação e tratamento de erro
